...
import server.common.Errors.{DBError, WalletError}
import doobie.implicits._
import cats.syntax.all._
import doobie.Transactor
import server.common.Errors.DBErrors.{DuplicateValues, PlayerOrCurrencyNotFound}
import server.common.Errors.WalletErrors.WalletIsNotFound
import server.database.SqlStates.{DUPLICATE_VALUES, FOREIGN_KEY_VIOLATION}
